...
class LDSCResultsAPI(Resource):
    ...
    def get(self, current_user_id):
        ...
        try:
            ...
            status = self.db.check_gene_expression_status(project_id, current_user_id)
            ...
            if status['has_data']:
                ...
                ldsc_results = self.db.get_gene_expression_results(
                    project_id=project_id,
                    user_id=current_user_id
                )
...
class TissueSelectionAPI(Resource):
    ...
    def get(self, current_user_id):
        ...
        try:
            ...
            tissues = self.db.get_available_tissues_for_selection(current_user_id, project_id)
    ...
    def post(self, current_user_id):
        ...
        try:
            ...
            available_tissues = self.db.get_available_tissues_for_selection(current_user_id, project_id)
            ...
            selection_id = self.db.save_tissue_selection(
